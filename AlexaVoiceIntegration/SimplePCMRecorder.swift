...
class SimplePCMRecorder {
    ...
    func startRecording() throws {
        ...
        guard self.recorderState.setupComplete else { throw NSError(domain: /*Config.Error.ErrorDomain*/"AlexaVoiceIntegration", code: /*Config.Error.PCMSetupIncompleteErrorCode*/9, userInfo: [NSLocalizedDescriptionKey : "Setup needs to be called before starting"]) }
